...
% Load results file
load('optimization_results_13poblem_30runs_30dim.mat');

filename = 'Optimization_Comparison_30dim.xlsx';
...
for algIdx = 1:numel(algorithms)
    ...
    for p = 1:numel(results)
        ...
        [lb, ub, dim, fobj] = Functions_30(problemName); % Extract problem details
