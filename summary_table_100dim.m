...
% Load results file
load('optimization_results_13poblem_30runs_100dim.mat');

filename = 'Optimization_Comparison_100dim.xlsx';
...
for algIdx = 1:numel(algorithms)
    ...
    for p = 1:numel(results)
        ...
        [lb, ub, dim, fobj] = Functions_100(problemName); % Extract problem details
