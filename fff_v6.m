...
for p = 1:numel(Problems)
    ...
    tic;
    startCPU = cputime;
    [BestSol_MHO, BestCost_MHO, Convergence_MHO] = MHO_Adaptive(problem, params);
    elapsedTimeMHO = toc;
    cpuTimeMHO = cputime - startCPU;
    max_MHO = max(Convergence_MHO);
    min_MHO = min(Convergence_MHO);
    mean_MHO = mean(Convergence_MHO);
    ...
    disp(['GA: Elapsed Time = ', num2str(elapsedTimeGA), ', CPU Time = ', num2str(cpuTimeGA)]);
    disp(['PSO: Elapsed Time = ', num2str(elapsedTimePSO), ', CPU Time = ', num2str(cpuTimePSO)]);
    disp(['GWO: Elapsed Time = ', num2str(elapsedTimeGWO), ', CPU Time = ', num2str(cpuTimeGWO)]);
    disp(['ABC: Elapsed Time = ', num2str(elapsedTimeABC), ', CPU Time = ', num2str(cpuTimeABC)]);
    disp(['SA: Elapsed Time = ', num2str(elapsedTimeSA), ', CPU Time = ', num2str(cpuTimeSA)]);
    disp(['MHO: Elapsed Time = ', num2str(elapsedTimeMHO), ', CPU Time = ', num2str(cpuTimeMHO)]);
    disp(['WO: Elapsed Time = ', num2str(elapsedTimeWO), ', CPU Time = ', num2str(cpuTimeWO)]);
    disp(['Puma: Elapsed Time = ', num2str(elapsedTimePUMA), ', CPU Time = ', num2str(cpuTimePUMA)]);
    disp(['HBO: Elapsed Time = ', num2str(elapsedTimeHBO), ', CPU Time = ', num2str(cpuTimeHBO)]);
    disp(['WOA: Elapsed Time = ', num2str(elapsedTimeWOA), ', CPU Time = ', num2str(cpuTimeWOA)]);
    ...
    results(p).GA = struct('BestSol', BestSol_GA, 'BestCost', BestCost_GA, 'Convergence', Conv_GA,...
                            ...
                            'Times', elapsedTimeGA, 'Cpu_times', cpuTimeGA);
    results(p).PSO = struct('BestSol', BestSol_PSO, 'BestCost', BestCost_PSO, 'Convergence', Conv_PSO,...
                            ...
                            'Times', elapsedTimePSO, 'Cpu_times', cpuTimePSO);
    results(p).GWO = struct('BestSol', BestSol_GWO, 'BestCost', BestCost_GWO, 'Convergence', Conv_GWO,...
                            ...
                            'Times', elapsedTimeGWO, 'Cpu_times', cpuTimeGWO);
    results(p).ABC = struct('BestSol', BestSol_ABC, 'BestCost', BestCost_ABC, 'Convergence', Conv_ABC,...
                            ...
                            'Times', elapsedTimeABC, 'Cpu_times', cpuTimeABC);
    results(p).SA = struct('BestSol', BestSol_SA, 'BestCost', BestCost_SA, 'Convergence', Conv_SA,...
                            ...
                            'Times', elapsedTimeSA, 'Cpu_times', cpuTimeSA);
    results(p).MHO = struct('BestSol', BestSol_MHO, 'BestCost', BestCost_MHO, 'Convergence', Convergence_MHO,...
                            'Max_value', max_MHO, 'Min_value', min_MHO, 'Mean_value', mean_MHO,...
                            'Times', elapsedTimeMHO, 'Cpu_times', cpuTimeMHO);
    results(p).WO = struct('BestSol', Best_Pos, 'BestCost', Best_Score, 'Convergence', Convergence_curve_WO,...
                            ...
                            'Times', elapsedTimeWO, 'Cpu_times', cpuTimeWO);
    results(p).Puma = struct('BestSol', Puma_X, 'BestCost', Puma_C, 'Convergence', Convergence_PUMA,...
                            ...
                            'Times', elapsedTimePUMA, 'Cpu_times', cpuTimePUMA);
    results(p).HBO = struct('BestSol', Leader_pos, 'BestCost', Leader_score, 'Convergence', Convergence_curve_HBO,...
                            ...
                            'Times', elapsedTimeHBO, 'Cpu_times', cpuTimeHBO);
    results(p).WOA = struct('BestSol', Leader_pos_WOA, 'BestCost', Leader_score_WOA, 'Convergence', Convergence_curve_WOA,...
                            ...
                            'Times', elapsedTimeWOA, 'Cpu_times', cpuTimeWOA);
end
